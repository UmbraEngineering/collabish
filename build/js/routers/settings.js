;require._modules["/routers/settings.js"] = (function() { var __filename = "/routers/settings.js"; var __dirname = "/routers"; var module = { loaded: false, exports: { }, filename: __filename, dirname: __dirname, require: null, call: function() { module.loaded = true; module.call = function() { }; __module__(); }, parent: null, children: [ ] }; var process = { title: "browser", nextTick: function(func) { setTimeout(func, 0); } }; var require = module.require = window.require._bind(module); var exports = module.exports; 
 /* ==  Begin source for module /routers/settings.js  == */ var __module__ = function() { 
...
// --------------------------------------------------------
 ...
 }; /* ==  End source for module /routers/settings.js  == */ return module; }());;